...
def plot_gradient_descent_2d(
    ...
    if stochastic:
        if batch_size is None:
            ...
            title = f"Minibatch Gradient Descent (batch_size = {batch_size})"
    else:
...
def plot_panel(f1, f2, f3, t1="Gradient Descent", t2="Stochastic Gradient Descent", t3="Minibatch Gradient Descent"):
    fig = make_subplots(
        rows=1,
        cols=3,
        subplot_titles=(
...
def plot_bitmojis(sample_batch):
